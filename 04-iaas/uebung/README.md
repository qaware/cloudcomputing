...
2b. Wiederholen Sie die Schritte in 2a um ein Netz in _eu-central-1b_ mit dem Adressbereich `10.0.128.0/17` zu erzeugen.
...
2. Klicken Sie in der Seitenleiste auf den Eintrag _Launch Templates_ > _Create Launch Template_.
    ...
    * Wählen Sie als _AMI_ ein Ubuntu auf ARM Basis: `ami-0aa72f02ca1be5339`.
    * Wählen Sie `t4g.micro` als Instanztyp
...
```
docker run -it --rm -e AWS_ACCESS_KEY_ID=<IHRE KEY ID> -e AWS_SECRET_ACCESS_KEY=<IHR ACCESS KEY> iaas-container
```
